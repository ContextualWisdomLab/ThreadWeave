...
| ADR-0010 Actions registry lifecycle evidence | GitHub Actions/Git trees REST API + issue #31 fleet incident | `scripts/ci/actions_registry_audit.py`, `.github/workflows/actions-registry-audit.yml` | exact protected-main/PR-head tree binding, complete pagination with page-repeat/total-count checks, finite classification tests, `actions: read`-only workflow permissions, 100% coverage/docstrings | accepted/implemented-main |
